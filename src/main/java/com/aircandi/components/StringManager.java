...
public class StringManager {
	...
	public static String getString(int resId) {
		String string = Patchr.applicationContext.getResources().getString(resId);
		return getString(string, Patchr.applicationContext, Patchr.applicationContext.getResources(), null);
	}
	...
	public static String getString(int resId, String schema) {
		String string = Patchr.applicationContext.getResources().getString(resId);
		return getString(string, Patchr.applicationContext, Patchr.applicationContext.getResources(), schema);
	}
