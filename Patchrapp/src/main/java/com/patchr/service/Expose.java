 ...
 * with {@code Gson gson = new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create()} then the {@code toJson()}
 * and {@code fromJson()} methods of Gson will exclude the {@code password} field. This is because the {@code password}
...
public @interface Expose {
	 ...
	 * @since 1.4
	 */
	public boolean serializeNull() default true;
