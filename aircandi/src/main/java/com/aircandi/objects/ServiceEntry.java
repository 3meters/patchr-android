...
public class ServiceEntry extends ServiceBase {
	...
	public static String getSchemaFromId(String id) {
		...
		String schema = null;
		if (schemaId.equals("us")) {
			schema = "user";
		}
		if (schemaId.equals("ac")) {
			schema = "action";
		}
		if (schemaId.equals("se")) {
			schema = "session";
		}
		if (schemaId.equals("in")) {
			schema = "install";
		}
		if (schemaId.equals("li")) {
			schema = "link";
		}
		if (schemaId.equals("do")) {
			schema = "document";
		}

		if (schemaId.equals("ap")) {
			schema = "applink";
		}
		if (schemaId.equals("be")) {
			schema = "beacon";
		}
		if (schemaId.equals("co")) {
			schema = "comment";
		}
		if (schemaId.equals("pl")) {
			schema = "place";
		}
		if (schemaId.equals("po")) {
			schema = "post";
		}
	...
	public static String getSchemaIdFromSchema(String schema) {
		...
		if (schema.equals("install")) {
			typeId = "in";
		}

		if (schema.equals("applink")) {
			typeId = "ap";
		}
		if (schema.equals("beacon")) {
			typeId = "be";
		}
		if (schema.equals("comment")) {
			typeId = "co";
		}
		if (schema.equals("place")) {
			typeId = "pl";
		}
		if (schema.equals("post")) {
			typeId = "po";
		}
		return typeId;
	}
